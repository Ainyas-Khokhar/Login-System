          ...
          <a class="nav-link  text-light" href="#">Link</a>
            ...
            if($_SESSION['user_role'] == 'admin'){
              echo '<li class="nav-item dropdown">'.
                ...
                //    '<li><a class="dropdown-item" href="#">Delete users</a></li>'.
...
<!-- ADD A TASK CLOSE BUTTON -->
<script>
    // JavaScript to handle opening and closing the modal
    document.getElementById('addTaskLink').addEventListener('click', function(event) {
...
<script>
  // Trigger the modal when the navbar link is clicked
document.getElementById('triggerModalLink').addEventListener('click', function(event) {
    event.preventDefault(); // Prevent the default link behavior
...
document.getElementById('customCloseFooterBtn').addEventListener('click', function() {
    document.getElementById('myCustomModal').style.display = 'none';
});

// Optional: Close the modal when clicking outside of it
window.addEventListener('click', function(event) {
    if (event.target === document.getElementById('myCustomModal')) {
        document.getElementById('myCustomModal').style.display = 'none';
    }
});
</script>
   ...
   <!-- <form action="logut.inc.php"><button class="btn" type="submit">logOUT</button></form> -->
